...
import com.fighter.reaper.sample.videolist.visibility.scroll.ItemsPositionGetter;
import com.fighter.reaper.sample.videolist.visibility.scroll.ScrollDirectionDetector;

/**
 * This class encapsulates some basic logic of Visibility calculator.
 * In onScroll event it calculates Scroll direction using {@link com.fighter.sample.videolist.visibility.scroll.ScrollDirectionDetector}
