package com.fighter.reaper.sample.videolist.visibility.items;
 ...
 * This interface is used by {@link com.fighter.sample.videolist.visibility.calculator.ListItemsVisibilityCalculator}
 *
 * @author Wayne
 */
public interface ListItem {
     ...
     */
    void setPositive(View newActiveView, int newActiveViewPosition);
     ...
     */
    void negative(View currentView, int position);
}
